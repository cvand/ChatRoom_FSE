function init() {
	...
	/*
	 * On client init, try to connect to the socket.IO server. Note we don't
	 * specify a port since we set up our server to run on port 8080
	 */
	var socket = io();
	...
	/*
	 * Show an error message if a user exists in the chat room with the same name
	 */
